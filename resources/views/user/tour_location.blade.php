                ...
                <div class="package-item">
                    ...
                    <div class="text-center pt-2">
                        ...
                        <div class="d-flex justify-content-center mb-2 pb-2">
                            ...
                            <a href="{{ route('user.tour.readmore', $tour->tour_id) }}" class="btn btn-sm btn-primary px-3 border-end">Đặt ngay</a>

                            <div class="btn-sm btn-primary px-3 border-end btn-far" style="border-radius: 0 30px 30px 0;" data-tour-id="{{ $tour->tour_id }}">
                                <i class="far fa-heart " id="favorite-btn-{{$tour->tour_id}}"></i>
                            </div>
