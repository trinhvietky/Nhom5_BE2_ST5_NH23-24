        ...
        <div class="row g-5">
            <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s" style="min-height: 400px;">
                <div class="position-relative h-100" id="imageDiv">
                    <img class="img-fluid position-absolute w-100 h-100" src="{{asset('img/about_us.jpg')}}" alt="" style="object-fit: cover;">
                </div>
            </div>
            <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
                ...
                <a class="btn btn-primary py-3 px-5 mt-2" href="{{ url('/admin.about') }}">Đọc tiếp ...</a>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="container">
        ...
        <div class="row g-3">
            ...
            <div class="col-lg-4 col-md-6 wow zoomIn" data-wow-delay="0.1s">
                <a class="position-relative d-block overflow-hidden" href="{{ route('admin.tour.location', ['location_id' => $row->location_id])}}">
...
<div class="container-xxl py-5">
    <div class="container">
        ...
        <div class="row justify-content-center py-3">
            <div class="col-auto">
                <a class="btn btn-primary rounded-pill py-3 px-4 mt-2" href="{{ url('/admin.team') }}">Xem thêm ...</a>
            </div>
        </div>
    </div>
</div>
